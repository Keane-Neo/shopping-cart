...
const Modal = ({ name, image, price, handleClose, handleSubmit }) => {
  return (
    <div className="w-full h-full top-0 bottom-0 left-0 right-0 fixed backdrop-blur">
      <div className=" bg-gray-800 w-3/5 h-3/5 ml-96 mt-40 text-white fixed">
        <div onClick={handleClose} className="absolute top-0 right-0">
          <strong>X</strong>
        </div>
        <img
          src={image}
        ...
        <div className="absolute top-40 right-40">
          ...
          <br />
          <p className="text-lg text-center">${price}.00</p>
          <br />
          <button
            type="text"
